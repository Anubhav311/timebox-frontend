...
function TimePicker(props) {
    ...
    function updateTime(e) {
        ...
        if (props.subtaskIndex) {
            ...
            const updatedTaskDueAt = console.log(`${tasks[props.columnIndex].date.getYear()+1900}-${('0' + (tasks[props.columnIndex].date.getMonth()+1)).slice(-2)}-${('0' + tasks[props.columnIndex].date.getDate()).slice(-2)}T${('0' + timeState.hour).slice(-2)}:${('0' + timeState.minute).slice(-2)}:00.000`)
